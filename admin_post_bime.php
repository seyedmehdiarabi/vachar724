...
<?php
$tbl_name="tbl_post_bime";
$f_count=6;
$msg='';
$page_id=66;
$form_title="تعریف هزینه بیمه محموله های پستی";
$grid_title="عناوین تعریف شده";
$col1_title="مبلغ ابتدا";
$col2_title="درصد بیمه";
$col1_grid="f1";
$col2_grid="f3";
$sort_field=" auto_id ";
...
<td align="right" width="23%" class="dirooz">از مبلغ (ریال) :</td>
<td align="right" width="72%" class="dirooz" colspan="2">
<input type="text" name="f1" size="40" dir="ltr" <?php if(isset($_GET["edit"])) print 'value="'.$selected_row[f1].'"';?>></td>
</tr>
<tr>
...
<img border="0" src="images/sp_forms.gif" width="50" ></td>
				...
				<tr>
<td align="center" width="5%" class="dirooz">&nbsp;</td>
<td align="right" width="23%" class="dirooz">تا مبلغ (ریال) :</td>
<td align="right" width="72%" class="dirooz" colspan="2">
<input type="text" name="f2" size="40" dir="rtl" <?php if(isset($_GET["edit"])) print 'value="'.$selected_row[f2].'"';?>></tr>
				</tr>
				<tr>
<td align="center" width="100%" class="dirooz" colspan="4">
<img border="0" src="images/sp_forms.gif" width="50" ></td>
...
<tr>
<td align="center" width="5%" class="dirooz">&nbsp;</td>
<td align="right" width="23%" class="dirooz">درصد حق بیمه :</td>
<td align="right" width="72%" class="dirooz" colspan="2">
