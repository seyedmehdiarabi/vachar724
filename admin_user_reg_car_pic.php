...
$form_title="مرحله سوم : ارسال تصاویر مربوط به آگهی خودرو";
...
FROM
  ...
  `tbl_adver_type` ON `tbl_adver_type`.`auto_id` = `tbl_car_master_info`.`f12` where tbl_car_master_info.auto_id=$item_id");
...
<!------------------------------------------------------------------------------------>					
					<input type=hidden name="babat" id="babat" value="6"> <!-- آگهی خودرو--->
<!------------------------------------------------------------------------------------>					
...
<?php }?>
						...
						<tr>
							<td width="30%" align="center">
								<input type="button" value="<?php if($reg_price>0) print 'هزینه را بعدا می پردازم ، برو به ثبت آگهی جدید'; else print 'برو به ثبت آگهی جدید'?>" name="b2" onClick="window.location.href='admin_user_reg_car_master.php';">
							</td>
