...
<?php
$tbl_name="tbl_tec_option";
$f_count=20;
$msg='';
$page_id=29;
$form_title="تنظیمات فنی اولیه";
...
<td align="right" width="20%" class="dirooz">آدرس <span lang="en-us">Url</span> 
ارسال پیامک :</td>
<td align="right" width="75%" class="dirooz" colspan="2">
<textarea rows="7" name="f1" cols="40" dir="ltr" ><?php if(isset($_GET["edit"])) print $selected_row[f1];?></textarea></td>
</tr>
<tr>
...
<tr>
<td align="center" width="5%" class="dirooz">&nbsp;</td>
<td align="right" width="20%" class="dirooz">نام فیلد شماره تلفن گیرنده پیام :</td>
<td align="right" width="75%" class="dirooz" colspan="2">
<input type="text" name="f2" size="20" dir="ltr" <?php if(isset($_GET["edit"])) print "value=".$selected_row[f2]; ?>></td>
</tr>
<tr>
<td align="center" width="100%" class="dirooz" colspan="4">
<img border="0" src="images/sp_forms.gif" width="50" height="7"></td>
...
<tr>
<td align="center" width="5%" class="dirooz">&nbsp;</td>
<td align="right" width="20%" class="dirooz">نام فیلد متن پیام :</td>
<td align="right" width="75%" class="dirooz" colspan="2">
<input type="text" name="f3" size="20" dir="ltr"   <?php if(isset($_GET["edit"])) print "value=".$selected_row[f3]; ?>></td>
</tr>
