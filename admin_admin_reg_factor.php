...
$form_title="";
$page_id=67;
$form_title="کلیه فاکتورهای پرداخت هزینه ثبت کالا توسط کاربران";
...
if($_POST["btn_close"])
{
	...
	for($i=0;$i<$count;$i++)
	{
		$k++;
		$id=$chbox[$i];
	    $r=mysql_query("update tbl_item_reg_m_factor set f4='1' where auto_id='$id' ");
	}
	
	$msg=" تعداد ".$k." عدد فاکتور بایگانی شد";
}// btn_close
...
FROM
  ...
  `tbl_user_info` ON `tbl_item_reg_m_factor`.`f1` = `tbl_user_info`.`auto_id`  where tbl_item_reg_m_factor.f4=0 order by auto_id desc";
	...
	<table class="tbl_1_border" dir="rtl">
					...
					<tr>
						<td align="center" width="100%"><div class="cell_header">
							<input type=submit name="btn_close" value="افزودن فاکتورهای انتخاب شده به لیست بایگانی" style="color: #FFFFFF"></div></td>
					</tr>
						<tr>
...
?>										<tr>
											...
											<td align="center" width="15%">
<?php if($row2["f6"]=="1") print "نو آکبند";
...
<?php } // of while?>										
										<tr>
											...
											<td align="center" width="15%" class="select_for_pay">&nbsp;</td>
												<td align="center" width="15%" class="select_for_pay">&nbsp;</td>
											<td align="center" width="15%" class="select_for_pay">&nbsp;</td>
											<td align="center" width="30%" class="select_for_pay"><input type='checkbox'  class="chk_pay" name='ch1[]'  id='ch1[]'  value="<?php print $row[auto_id]; ?>" >بایگانی 
											کردن</td>
										</tr>
										<tr >
