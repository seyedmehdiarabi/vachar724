								...
								<div class="col-sm-3">
									<div class="product-image-wrapper">
										<div class="single-products">
											...
											<img src="images/items_pic/<?php print $row_other["auto_id"]?>_larg_1.jpg" title="<?php print $row_other[f3]?>" alt="<?php print $row_other[f3]?> در آرکا" />												
...
if($seller_info["f25"]==0)
{
 ?>							
 				...
 				<h3>اطلاعات فروشنده به درخواست وی نمایش داده نمی شود</h3>
 				</div>
 				</div>
 <?php }
 else{
 ?>				
								...
								<div class="col-sm-12">
									...
									<div class="detail_pic" ><img width=150px alt="<?php print $seller_info[s_user_name].'  '.$seller_info[s_famil]?> در آرکا" title="<?php print $seller_info[s_user_name].'  '.$seller_info[s_famil]?>" src="<?php print $user_pic?>">
										...
										<p ><b>تاریخ عضویت در آرکا  :  </b><span><?php print $seller_info["s_reg_date"]?></span></p>
...
<?php }?>																	
									<div class="col-sm-4">
										<div class="product-image-wrapper">
											<div class="single-products">
												<div class="productinfo text-center">
														<img src="images/items_pic/<?php print $row_moshabeh["auto_id"]?>_larg_1.jpg" title="<?php print $row_moshabeh[f3]?>" alt="<?php print $row_moshabeh[f3]?> در آرکا" />
