...
<?php
$tbl_name="tbl_favicon";
$f_count=6;
$msg='';
$page_id=49;
$form_title="تنظیم Favicon";
$grid_title="عناوین تعریف شده";
$col1_title="عنوان آیکون";
$col2_title="اولویت";
$col1_grid="f1";
$col2_grid="f3";
$sort_field=" f3 asc ";
...
<td align="right" width="20%" class="dirooz">عنوان آیکون:</td>
...
<tr>
<td align="center" width="5%" class="dirooz">&nbsp;</td>
<td align="right" width="20%" class="dirooz">فایل آیکون:</td>
<td align="right" width="35%" class="dirooz">
