...
$form_title="";
$page_id=68;	
$form_title="کلیه فاکتورهای خرید از آرکا توسط کاربران";
...
if($_POST["btn_close"])
{
	...
	for($i=0;$i<$count;$i++)
	{
		$k++;
		$id=$chbox[$i];
	    $r=mysql_query("update tbl_recive_order_master set f7='1' where auto_id='$id' ");
	}
	
	$msg=" تعداد ".$k." عدد فاکتور مختومه گردید ";
}// btn_close
...
FROM
  ...
  `tbl_recive_order_master` ON `tbl_recive_order_master`.`f2` = `tbl_user_info`.`auto_id`  where `tbl_recive_order_master`.`f7`=0 order by auto_id desc";
	...
	<table class="tbl_1_border" dir="rtl">
					...
					<tr>
						<td align="center" width="100%"><div class="cell_header">
							<input type=submit name="btn_close" value="مختومه کردن فاکتورهای انتخاب شده" style="color: #FFFFFF"></div></td>
					</tr>
...
<?php } // of while?>										
										<tr>
											...
											<td align="center" width="15%" class="select_for_pay">&nbsp;</td>
												<td align="center" width="15%" class="select_for_pay">&nbsp;</td>
											<td align="center" width="15%" class="select_for_pay">&nbsp;</td>
											<td align="center" width="30%" class="select_for_pay"><input type='checkbox'  class="chk_pay" name='ch1[]'  id='ch1[]'  value="<?php print $row[auto_id]; ?>" >انتخاب 
											برای مختومه شده</td>
										</tr>
										<tr >
