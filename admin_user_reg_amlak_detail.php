...
$form_title="مرحله دوم ثبت جزئیات کامل ملک";
$valid_fld="";
$test_array="";
$page_id=80;
...
$re0=mysql_query("select f1 from tbl_amlak_master_info where auto_id=$item_id");
...
function create_value($auto_id,$title,$f2,$f3,$f4,$edit,$item_id)
{
	...
	{
		$old_val="";
		$r1=mysql_query("select f3 from tbl_amlak_detail_info where f1=$item_id and f2=$auto_id");
	...
	switch($f2)
	{
		...
		case "loockup":
		{
			...
			$r=mysql_query("select auto_id,f2 from tbl_amlak_pre_need_loockup where f1=$auto_id");
...
<div align="center">
<div class="main_form">
<form method="POST" action="admin_user_reg_amlak_pic.php" name="frm1" id="frm1">
...
<?php 
	$re=mysql_query("select auto_id,f1,f2,f3,f4,f5 from tbl_amlak_pre_need where f7=0 or f7=$sub_group_id order by f6");
	$valid_fld="";
	$fld_name="";
	$test_array="";
...
var frm_name="frm1";
var tbl_name="tbl_amlak_detail_info";
//=========================================
