...
<?php
$tbl_name="tbl_car_pre_need";
$f_count=8;
$msg='';
$page_id=78;
$form_title="مدیریت مشخصه های فنی خودرو";
...
<a href="admin_car_pre_need_loockup.php?car_pre_id=<?php print $row[auto_id];?>&car_pre_name=<?php print $row[f1]?>">ثبت</a></td>
<?php }?>
</tr>
<?php }
?>
