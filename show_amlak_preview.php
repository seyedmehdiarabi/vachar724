...
FROM
  `tbl_amlak_master_info` LEFT JOIN
  `tbl_shahr` ON `tbl_amlak_master_info`.`f3` = `tbl_shahr`.`shahr_id` where `tbl_amlak_master_info`.`auto_id`=$item_id");
...
FROM
  `tbl_amlak_master_info` LEFT JOIN
  `tbl_shahr` ON `tbl_amlak_master_info`.`f3` = `tbl_shahr`.`shahr_id` where (`tbl_amlak_master_info`.`f8`=1 or `tbl_amlak_master_info`.`f8`=3) and `tbl_amlak_master_info`.`f6`=1 and `tbl_amlak_master_info`.`f2`=$user_code and `tbl_amlak_master_info`.`auto_id`<>$item_id");
...
mysql_query("SET CHARACTER SET $charset ");	
  ...
  `tbl_amlak_pre_need`.`f1` as a_title, `tbl_amlak_pre_need`.`f5` as a_unit,
  `tbl_amlak_detail_info`.`f3` as a_val
FROM
  `tbl_amlak_pre_need` RIGHT JOIN
...
FROM
  `tbl_amlak_master_info` LEFT JOIN
  `tbl_shahr` ON `tbl_amlak_master_info`.`f3` = `tbl_shahr`.`shahr_id` where (`tbl_amlak_master_info`.`f8`=1 or `tbl_amlak_master_info`.`f8`=3) and `tbl_amlak_master_info`.`f6`=1 and `tbl_amlak_master_info`.`f1`=$item_group and `tbl_amlak_master_info`.`auto_id`<>$item_id  order by `tbl_amlak_master_info`.`auto_id` desc  limit 30 ");
$num=mysql_num_rows($re);
