...
<?php
$tbl_name="tbl_amlak_pre_need_loockup";
$f_count=2;
$msg='';
$page_id=79;
$form_title="تعريف زیر مجموعه های فنی مشخصه های املاک";
...
if($_GET["amlak_pre_name"]!=""||$_GET["amlak_pre_id"]!="")
{
	$_SESSION["amlak_pre_id"]="";
	$_SESSION["amlak_pre_name"]="";
}

if ($_SESSION["amlak_pre_id"]=="")
{
	$_SESSION["amlak_pre_id"]=$_GET["amlak_pre_id"];
	$_SESSION["amlak_pre_name"]=$_GET["amlak_pre_name"];
}	

if ($_SESSION["amlak_pre_id"]=="")
	header("Location: admin_item_info.php");
		
$str_where=" where f1=".$_SESSION["amlak_pre_id"];
print $str_where;
		...
		<table border="0"  dir="rtl" cellspacing="0" style="border-collapse: collapse" class="main_table">
			...
			<?php print $form_title?></td>
				...
				<tr>
					...
					<tr>
						<td align="center" width="100%" colspan="4"><?php print $_SESSION["amlak_pre_name"]?></td>
					</tr>
...
<input type="hidden" name="f1" id="f1" value="<?php print $_SESSION["amlak_pre_id"]?>">
