...
var f_date_name="";
var first_f="f1";
var no_empty=new Array("f1","f3")
var test_array=new Array(1,0);
var onload_array=new Array(1,0,1);
</script>
<?php
$tbl_name="tbl_customer_type";
$f_count=9;
$msg='';
$page_id=6;
$form_title="تعريف گروه هاي مختلف مشتريان";
$grid_title="ليست گروه هاي مشتريان تعريف شده";
$col1_title="عنوان گروه";
$col2_title="درصد تخفيف";
$col1_grid="f1";
$col2_grid="f3";
...
<td align="right" width="20%" class="dirooz">عنوان گروه مشتري :</td>
...
<tr>
<td align="center" width="5%" class="dirooz">&#1645;</td>
<td align="right" width="20%" class="dirooz">درصد تخفيف :</td>
<td align="right" width="35%" class="dirooz">
...
<input type="submit" onclick= "return aseman_test();" <?php if(isset($_GET["edit"])) print 'value= "ويرايش اطلاعات" name=B2';  else print 'value="ذخيره اطلاعات در سيستم" name="B1"'?> >
<span lang="en-us">&nbsp;
						</span>&nbsp;</td>
