...
<?php
$tbl_name="tbl_license";
$f_count=8;
$msg='';
$page_id=2;
$form_title="مدیریت مجوزهای فروشگاه(اینماد - ستاد ساماندهی)";
$grid_title="ليست مجوزهای ثبت شده";
$col1_title="عنوان مجوز";
$col2_title="پیش نمایش";
$col1_grid="f1";
$col2_grid="f2";
...
<td align="right" width="20%" class="dirooz">عنوان مجوز :</td>
...
<tr>
<td align="center" width="5%" class="dirooz">&nbsp;</td>
<td align="right" width="20%" class="dirooz">کد مجوز :</td>
...
<option <?php if(isset($_GET["edit"])) if ($selected_row["f4"]=="1") print "selected"?> value="1">نمایش داده شود
										</option>
<option <?php if(isset($_GET["edit"])) if ($selected_row["f4"]=="0") print "selected"?> value="0">فعلا نمایش داده نشود
										</option>
